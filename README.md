...
> 基于天玑9300+ 的**调度**模块 v1.0.43 · 作者：偷吃性能

一个设计初衷**只为了用 scene 接管调度功能**所写的调度模块，几乎保留了所有官调内容，又可以蹭 scene 的调度功能（核心分配、旁路充电）。虽是假调度，但包含调度基本的频率切换、cpuset、情景模式、GPU/DDR/MIGT 控制功能。
